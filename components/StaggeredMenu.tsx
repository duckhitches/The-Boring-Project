...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  className,
  // Default to a real file in `public/` (Next.js can serve this).
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <div className="sm-header-left" aria-label="Brand">
          ...
          {title && <div className="sm-header-title text-black">{title}</div>}
        </div>
